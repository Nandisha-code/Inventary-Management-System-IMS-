            ...
            <div class="p-4">
                ...
                <nav>
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="products.php" class="flex items-center p-2 rounded bg-blue-800">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="mt-4 flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Showing <span id="startItem">1</span> to <span id="endItem">10</span> of <span id="totalItems">0</span> products
                    </div>
                    <div class="flex space-x-2">
                        <button id="prevPage" class="px-3 py-1 border border-gray-300 rounded-md text-gray-700 disabled:opacity-50" disabled>
                            Previous
                        </button>
                        <button id="nextPage" class="px-3 py-1 border border-gray-300 rounded-md text-gray-700 disabled:opacity-50" disabled>
                            Next
                        </button>
                    </div>
                </div>  
